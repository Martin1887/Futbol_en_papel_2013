package futbolEnPapel2013.jugador.controladores.programacionGenetica.arbol.operadores.logicos;
 ...
 * @version 1.0
 */
public class NoIgual extends Operador {
    ...
    * operando != operando
    * @return La representación de la comparación en String
    */
   @Override
    ...
    * @return nI Un objeto igual a éste
    */
   @Override
   public NoIgual clone() {
       NoIgual nI = new NoIgual();
       nI.setHijos(getHijos());
       return nI;
   }
