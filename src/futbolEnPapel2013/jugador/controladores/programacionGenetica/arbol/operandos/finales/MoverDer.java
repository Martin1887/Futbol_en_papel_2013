...
/**
 * Clase que representa el operando de mover a la derecha
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverDer extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverDer()
     * @return "padre.moverDer();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverDer();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
