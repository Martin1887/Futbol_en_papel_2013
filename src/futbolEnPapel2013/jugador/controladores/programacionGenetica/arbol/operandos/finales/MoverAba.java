...
/**
 * Clase que representa el operando de mover abajo
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverAba extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverAba()
     * @return "padre.moverAba();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverAba();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
