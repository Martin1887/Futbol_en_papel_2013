...
/**
 * Clase que representa el operando de mover arriba
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverArr extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverArr()
     * @return "padre.moverArr();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverArr();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
