...
/**
 * Clase que representa el operando de mover abajo a la izquierda
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverAbI extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverAbI()
     * @return "padre.moverAbI();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverAbI();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
