...
/**
 * Clase que representa el operando de mover arriba a la derecha
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverArD extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverArD()
     * @return "padre.moverArD();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverArD();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
