...
/**
 * Clase que representa el operando de mover a la izquierda
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverIzq extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverIzq()
     * @return "padre.moverIzq();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverIzq();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
