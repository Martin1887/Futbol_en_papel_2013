...
/**
 * Clase que representa el operando de mover arriba a la izquierda
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class MoverArI extends Final {

    /**
     * Lo que representa este nodo es la invocación del método padre.moverArI()
     * @return "padre.moverArI();"
     */
    @Override
    public String toString() {
        return "Posicion actual = padre.getActual();\n"
                + "boolean mueve = padre.moverArI();\n"
                + "if (bloqueo()) {\n\treturn;\n}\n"
