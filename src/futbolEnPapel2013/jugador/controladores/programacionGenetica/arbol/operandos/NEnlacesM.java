...
/**
 * Clase que representa la invocación al método nEnlacesM()
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class NEnlacesM extends Operando {
    ...
    /**
     * Devuelve un String con la representación de la invocación a nEnlacesM()
    ...
    */
   @Override
   public NEnlacesM clone() {
       return new NEnlacesM();
   }
