...
/**
 * Clase que representa la invocación al método distMiMeta()
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class DistMiMeta extends Operando {
    ...
    /**
     * Devuelve un String con la representación de la invocación a distMiMeta()
    ...
    */
   @Override
   public DistMiMeta clone() {
       return new DistMiMeta();
   }
