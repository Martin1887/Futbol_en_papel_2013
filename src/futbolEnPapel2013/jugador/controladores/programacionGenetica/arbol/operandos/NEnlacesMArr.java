...
/**
 * Clase que representa la invocación al método nEnlacesMArr()
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class NEnlacesMArr extends Operando {
    ...
    /**
     * Devuelve un String con la representación de la invocación a nEnlacesMArr()
    ...
    */
   @Override
   public NEnlacesMArr clone() {
       return new NEnlacesMArr();
   }
