 ...
 * @version 1.0
 */
public class AlfaBetaEstatico extends Controlador {
    ...
    public void mover(Juego juego) throws Exception {
        ...
        double v = minValor(raiz, -INFINITO, INFINITO, indice, 0);
     ...
     */
    public double maxValor(EstadoEstatico estado, double alfa, double beta, int indice, int profRebotes) {
        double v;
     ...
     */
    public double minValor(EstadoEstatico estado, double alfa, double beta, int indice, int profRebotes) {
        double v;
