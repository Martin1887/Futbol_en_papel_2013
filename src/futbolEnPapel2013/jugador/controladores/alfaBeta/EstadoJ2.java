 ...
 * @version 1.0
 */
public class EstadoJ2 extends Estado {
     ...
     * @param nueva
     */
    public EstadoJ2(Posicion nueva) {
        valor = AlfaBetaEstatico.INFINITO;
        posicion = nueva;
        hijos = new EstadoJ2[8];
    }
    ...
    public void setHijos(Estado[] nuevos) throws Exception {
        ...
        if (algunoNoNull) {
            throw new Exception("¡Intentas poner como hijos de un EstadoDinJ2 Estados de otro tipo!");
        }
    }
    ...
    public void setHijo(int elemento, Estado hijo) throws Exception {
        if (hijo != null) {
            if (hijo.getClass() == this.getClass()) {
                ...
                throw new Exception("¡Intentas poner como hijo de un EstadoDinJ2 Estados de otro tipo!");
            }
        } else {
            hijo = null;
        }
    ...
    public Estado clone() {
        ...
        EstadoJ2 estado = new EstadoJ2(posicionNueva);
