 ...
 * @version 1.0
 */
public class EstadoEstaticoJ1 extends EstadoEstatico {

    /**
     * Constructor
     * @param nueva
     */
    public EstadoEstaticoJ1(Posicion nueva) {
        valor = new double[8];
    ...
    public EstadoEstatico clone() {
        ...
        EstadoEstaticoJ1 estado = new EstadoEstaticoJ1(posicionNueva);
