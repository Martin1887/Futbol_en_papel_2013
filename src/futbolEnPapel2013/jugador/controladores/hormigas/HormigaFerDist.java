 ...
 * para dejar feromona (excepto cuando vuelve)
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class HormigaFerDist {
     ...
     */
    public HormigaFerDist(Grafo gr, Posicion base, Posicion porteria) {
        grafo = gr;
        hormiguero = base;
        meta = porteria;
...
//                    costeTotal -= Math.min(aBorrar.getCoste(0), aBorrar.getCoste(1));
        ...
        // distancia a la meta rival (0.4/coste + 10/distancia)
        double suma = 0;
