...
/**
 * Clase que representa una hormiga que usa la distancia a la portería rival
 * y también el min(coste * distancia a la propia) para dejar feromona
 * (excepto cuando vuelve)
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class HormigaFerDistRival {
     ...
     */
    public HormigaFerDistRival(Grafo gr, Posicion base, Posicion porteria) {
        grafo = gr;
        hormiguero = base;
        meta = porteria;
...
//                                    g.getGrafo().getNodos()[i][j].getEnlaces()[k].getCoste(1))
    ...
    /**
     * Método que limpia el camino y los enlaces para la siguiente iteración
