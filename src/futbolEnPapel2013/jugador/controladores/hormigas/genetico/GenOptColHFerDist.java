...
/**
 * Clase que implementa el algoritmo genético que optimiza las hormigas que usan
 * la distancia para dejar feromona.
 * La codificación usada es 8 números en binario de 8 bits codificados en
 ...
 * pesoCoste * 100 - 1
 * pesoDistancia * 10 - 1 (tiene que tener mayores valores y la precisión decimal no importa tanto)
 * minFeromona * 10 - 1 (puede tener mayores valores y la precisión decimal no importa tanto)
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class GenOptColHFerDist {
    ...
    public static double fEvaluacion(BitSet[] individuo, int elemento, boolean intermedia, BufferedWriter fSalida,
        ...
        int niv1 = Juego.C_HORMIGAS_FER_DIST_GEN_EVAL;
        int niv2 = 1;
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (8 parámetros)
         */
        BitSet[][] generacion = new BitSet[16][9];
...
//        ruta = teclado.readLine();
        ...
        // Se ponen los 2 mejores individuos de la ejecución anterior
//        generacion[0][0].set(0);
//        generacion[0][0].set(1);
//        generacion[0][0].set(3);
//        generacion[0][0].set(4);
//        generacion[0][0].set(5);
//        generacion[0][1].set(0);
//        generacion[0][1].set(1);
//        generacion[0][2].set(2);
//        generacion[0][2].set(3);
//        generacion[0][2].set(6);
//        generacion[0][2].set(7);
//        generacion[0][3].set(0);
//        generacion[0][3].set(3);
//        generacion[0][3].set(4);
//        generacion[0][3].set(5);
//        generacion[0][3].set(7);
//        generacion[0][4].set(1);
//        generacion[0][4].set(2);
//        generacion[0][4].set(3);
//        generacion[0][4].set(4);
//        generacion[0][4].set(5);
//        generacion[0][5].set(0);
//        generacion[0][5].set(3);
//        generacion[0][5].set(4);
//        generacion[0][5].set(5);
//        generacion[0][5].set(6);
//        generacion[0][5].set(7);
//        generacion[0][6].set(1);
//        generacion[0][6].set(3);
//        generacion[0][6].set(4);
//        generacion[0][6].set(7);
//        generacion[0][7].set(1);
//        generacion[0][7].set(2);
//        generacion[0][7].set(3);
//        generacion[0][7].set(7);
//        generacion[0][8].set(1);
//        generacion[0][8].set(3);
//        generacion[0][8].set(4);
//        generacion[1][0].set(1);
//        generacion[1][0].set(4);
//        generacion[1][1].set(1);
//        generacion[1][2].set(1);
//        generacion[1][2].set(2);
//        generacion[1][2].set(4);
//        generacion[1][2].set(7);
//        generacion[1][3].set(2);
//        generacion[1][3].set(4);
//        generacion[1][3].set(5);
//        generacion[1][3].set(6);
//        generacion[1][3].set(7);
//        generacion[1][4].set(1);
//        generacion[1][4].set(2);
//        generacion[1][4].set(3);
//        generacion[1][4].set(4);
//        generacion[1][4].set(5);
//        generacion[1][4].set(6);
//        generacion[1][5].set(0);
//        generacion[1][5].set(3);
//        generacion[1][5].set(4);
//        generacion[1][5].set(6);
//        generacion[1][5].set(7);
//        generacion[1][6].set(0);
//        generacion[1][6].set(2);
//        generacion[1][6].set(3);
//        generacion[1][6].set(4);
//        generacion[1][7].set(0);
//        generacion[1][7].set(3);
//        generacion[1][7].set(4);
//        generacion[1][7].set(5);
//        generacion[1][7].set(6);
//        generacion[1][7].set(7);
//        generacion[1][8].set(1);
//        generacion[1][8].set(4);
//        generacion[1][8].set(7);
...
//        }
        ...
        for (int i = 0; i < nHilos; i++) {
            ...
            EvaluacionFerDistGen evaluador = new EvaluacionFerDistGen(individuos, evaluaciones,
         ...
         * y la evaluación es al menos 900
         */
        while (fin == false) {
...
//            }
            ...
            for (int i = 0; i < tamano; i++) {
                ...
                EvaluacionFerDistGen evaluador = new EvaluacionFerDistGen(individuos, evaluacionesIntermedia,
            ...
            if ((evMejorAnt - evaluaciones[mejor(generacion, evaluaciones)] < TOL)
                    && evaluaciones[mejor(generacion, evaluaciones)] >= 900) {
                fin = true;
            }
        ...
        System.out.println("Mejor individuo: ");
        for (int i = 0; i < mejorAnt.length; i++) {
            System.out.print(String.valueOf(mejorAnt[i]) + ", ");
        }
        System.out.println();
        System.out.println("Mejor puntuación: " + evMejorAnt);
