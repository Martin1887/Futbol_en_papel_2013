 ...
 * la colonia de hormigas que usan la distancia para dejar feromona en un hilo aparte.
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class EvaluacionFerDistGen extends Thread {
     ...
     * @param bar
     */
    public EvaluacionFerDistGen(BitSet[][] ind, double[] ev, int primerEl, boolean inter,
    ...
    public void ejecutarEvaluaciones() {
        ...
        for (int i = 0; i < individuos.length; i++) {
            evaluaciones[i + primerElemento] = GenOptColHFerDist.fEvaluacion
