...
/**
 * Clase que representa una hormiga que usa la distancia para dejar feromona
 * cuyos parámetros han sido optimizados mediante un algoritmo genético
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class HormigaFerDistGen {
     ...
     */
    public HormigaFerDistGen(Grafo gr, Posicion base, Posicion porteria) {
        grafo = gr;
        hormiguero = base;
        meta = porteria;
...
//                    costeTotal -= Math.min(aBorrar.getCoste(0), aBorrar.getCoste(1));
        ...
        // distancia a la meta rival (pesoCoste/coste + pesoDistancia/distancia)
