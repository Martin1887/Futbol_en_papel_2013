...
/**
 * Clase que representa una hormiga cuyos parámetros han sido optimizados
 * mediante un algoritmo genético
 * @author Marcos Martín Pozo Delgado
 * @version 1.0
 */
public class HormigaGen {
     ...
     */
    public HormigaGen(Grafo gr, Posicion base, Posicion porteria) {
        grafo = gr;
        hormiguero = base;
        meta = porteria;
