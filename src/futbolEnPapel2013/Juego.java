...
//        turnoJ2.setVisible(false);
        ...
        if (padre.getJug1() != PERSONA) {
            ...
            switch (nivel1) {
                ...
                case 9:
                case 10:
                    textoNivel1.setText("Nivel del jugador 1: Alfabeta profundidad " + nivel1);
                    break;
                case C_HORMIGAS:
                    textoNivel1.setText("Nivel del jugador 1: Colonia de hormigas");
                    break;
                case C_HORMIGAS_FER_DIST:
                    textoNivel1.setText("Nivel del jugador 1: Colonia de hormigas mejorada");
                    break;
                case C_HORMIGAS_FER_DIST_RIVAL:
                    textoNivel1.setText("Nivel del jugador 1: Colonia de hormigas suprema");
                    break;
                case C_HORMIGAS_GEN:
                    textoNivel1.setText("Nivel del jugador 1: Colonia de hormigas");
                    break;
        ...
        if (padre.getJug2() != PERSONA) {
            ...
            switch (nivel2) {
                ...
                case 9:
                case 10:
                    textoNivel2.setText("Nivel del jugador 2: Alfabeta profundidad " + nivel2);
                    break;
                case C_HORMIGAS:
                    textoNivel2.setText("Nivel del jugador 2: Colonia de hormigas");
                    break;
                case C_HORMIGAS_FER_DIST:
                    textoNivel2.setText("Nivel del jugador 2: Colonia de hormigas mejorada");
                    break;
                case C_HORMIGAS_FER_DIST_RIVAL:
                    textoNivel2.setText("Nivel del jugador 2: Colonia de hormigas suprema");
                    break;
                case C_HORMIGAS_GEN:
                    textoNivel2.setText("Nivel del jugador 2: Colonia de hormigas");
                    break;
